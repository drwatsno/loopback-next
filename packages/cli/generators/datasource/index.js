...
const index = require('../../lib/make-index');
...
module.exports = class DataSourceGenerator extends ArtifactGenerator {
  ...
  scaffold() {
    ...
    // prettier-ignore
    this.artifactInfo.tsFileName = `${this.artifactInfo.fileName}.datasource.ts`;
    ...
    debug(`this.artifactInfo.tsFileName => ${this.artifactInfo.tsFileName}`);
